    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? courseID)
        {
            ...
            viewModel.Instructors = await _context.Instructors
                ...
                //            .ThenInclude(i => i.Student) { This code is for Eager loading of enrollments in course }
                .Include(i => i.CourseAssignments)
                    .ThenInclude(i => i.Course)
            ...
            if (courseID != null)
            {
                ...
                //viewModel.Enrollments = viewModel.Courses.Where(c => c.CourseID == courseID).Single().Enrollments; { eager loading }

                // Explicit loading - particular record is selected not the whole table
